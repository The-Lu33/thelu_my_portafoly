...
export default function Nav({ activePage, setActivePage }: { activePage: string, setActivePage: (page: string) => void }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full bg-[#2b2b2cbf] backdrop-blur-md border border-[#383838] rounded-t-2xl shadow-[0_16px_30px_#00000040] z-50 lg:absolute lg:bottom-auto lg:top-0 lg:left-auto lg:right-0 lg:w-max lg:rounded-t-[20px] lg:pt-[20px] lg:shadow-none">
